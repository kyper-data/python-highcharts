...
H.add_data_set(data,'line', marker = {'states':{'hover':{'enabled':True, 'fillColor':'white', 'lineColor': 'red','lineWidth': 2}}},
  events = {'click': "function (event) { alert(this.name + ' clicked\\n' + 'Alt: ' + event.altKey + '\\n' + \
...
H.set_options('chart',{'style':{'fontFamily': 'Lucida Grande, sans-serif', \
 "fontfontSize": '12px'}})
...
#print H.options['chart'].__dict__['resetZoomButton'].__options__()
#print H.options['xAxis'].__dict__['events'].__options__() 
H.file()