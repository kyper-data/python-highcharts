...
class NVD3Chart(object):
    ...
    def __init__(self, **kwargs):
        ...
        :keyword: **margin_bottom** - default - ``30``
        :keyword: **margin_left** - default - ``80``
        :keyword: **margin_right** - default - ``80``
        ...
        :keyword: **date_format** - default - ``%x`` # not sure of the purpose.....could be a legacy
        ...
        self.margin_bottom = kwargs.get('margin_bottom', 30)
        self.margin_left = kwargs.get('margin_left', 80)
        self.margin_right = kwargs.get('margin_right', 80)
        ...
        #self.date_format = kwargs.get('date_format', '%x') # not sure of the purpose, could be a legacy
        ...
        self.header_css = [
            ...
            (
                'https://cdnjs.cloudflare.com/ajax/libs/nvd3/1.7.1/nv.d3.css',
            )
        ]
        ...
        self.header_js = [
            ...
            (
                ...
                'https://cdnjs.cloudflare.com/ajax/libs/nvd3/1.7.1/nv.d3.js'
            )
        ]
    ...
    def add_serie(self, y, x, name=None, **kwargs):
        ...
        **Attributes**:
        ...
        if 'shape' in kwargs or 'size' in kwargs:
            ...
            elif self.model == 'ohlcBarChart':
                serie = [{'x': x[i], 'open': y['open'], 'high': y['high'], 'low': y['low'], 'close': y['close']} for i, y in enumerate(y)]
            else:
    ...
    def create_x_axis(self, name, label=None, label_dist=None, format=None, date=False, custom_format=False):
        """Create X-axis"""
        axis = {}
        ...
        if label_dist:
            axis['axisLabelDistance'] = label_dist
    ...
    def create_y_axis(self, name, label=None, label_dist=None, format=None, custom_format=False):
        """
        Create Y-axis
        """
        axis = {}
